...
- 약재/처방: 뜸의 주요 재료는 쑥(艾)이며, 생강(生薑)·마늘(蒜)·염(鹽)·약물(藥)을 간접구의 격물(隔物)로 사용한다.[^17][^25] 한약과 병용 시 용담사간탕(龍膽瀉肝湯)·기신통맥음(氣腎通脈飲)·통룡대시대시탕(通龍大石大石湯) 등이 활용된다.[^23][^30] 이 중 [합곡(合谷)](../../기초한의학/경락경혈학/합곡(合谷, LI4).md)은 침뜸 치료에서 통증·염증 조절에 활용되는 경혈이다(교과서적 근거).
