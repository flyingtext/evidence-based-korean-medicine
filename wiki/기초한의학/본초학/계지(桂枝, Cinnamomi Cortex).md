...
- 약재/처방: 계지는 계지탕(桂枝湯)·계지복령환(桂枝茯苓丸)·황기계지오물탕(黃芪桂枝五物湯)·시호계지탕(柴胡桂枝湯)·계지가출부탕(桂枝加朮附湯)·계지작약지모탕(桂枝芍藥知母湯) 등에서 핵심 온경통맥·발한약으로 쓰이며, 복령(茯苓, Poria)·작약(芍藥, Paeonia)·황기(黃芪, Astragalus)·시호 등과 배합된다.[^1][^3][^7][^11][^17]
