...
- 계지탕(桂枝湯, Gyeji-tang / Keishito / Guizhi Decoction)
  - 하위 표제어: 계지탕(桂枝湯) 원방 · 계지탕 가감방(계지탕가황기·계지탕가구주) · 계지 계열 파생 방제(시호계지탕·계지복령환·황기계지오물탕·계지작약지모탕·지실해백계지탕)
...
- 사역탕(四逆湯, Sini Decoction / Shigyakuto)
  - 하위 표제어: 사역탕(四逆湯) 원방 · 당귀사역탕(當歸四逆湯, 별도 문서) · 가미사역탕(加味四逆湯) · 통맥사역탕(通脈四逆湯) · 사역산(四逆散)
- 당귀사역탕(當歸四逆湯, Danggui Sini Tang / Dang-Gui-Si-Ni-Tang)
  - 하위 표제어: 당귀사역탕(當歸四逆湯) 원방 · 당귀사역가오수유생강탕(當歸四逆加吳茱萸生薑湯) · 가감당귀사역탕(레이노 현상·당뇨병성 족부궤양·관상동맥질환·하지동맥경화폐색증 등)
...
- 정전가미이진탕(正傳加味二陳湯, Jeongjeon Gamiyijin-tang)
  - 하위 표제어: 정전가미이진탕(正傳加味二陳湯) · 이진탕(二陳湯) 계열 담음형 비만 처방 · 유사 처방(황련해독탕·감비산·창부다단탕)
- 소적건비환(消積健脾丸, Xiaoji Jianpi Wan)
  - 하위 표제어: 소적건비환(消積健脾丸) · 보화환(保和丸) 계열 소식화적방 · 이공산(異功散)·삼령백출산(蔘苓白朮散) 계열 건비방
- 청파전(淸破煎, Cheongpajeon)
  - 자생한방병원 계열 원내처방(院內處方). 고전 출전 없이 요추관 협착증·경추 추간판 탈출증 통합 치료(신바로 약침·추나 병용)에 사용되는 것으로 진료 실태 설문 문헌에 명시되어 있으며, 세부 조성은 공개 문헌에서 확인되지 않는다.
- 청혈단(淸血丹, Cheonghyeoldan / Chunghyul-dan, Qingxue-dan)
  - 경희대학교 한방병원 계열 원내처방(院內處方). 황금·황련·황백·치자(황련해독탕)에 대황을 더한 조성으로, 이상지질혈증·고혈압·동맥경화·허혈성 뇌졸중 재발 예방 영역에서 임상 근거가 축적되어 있다.
