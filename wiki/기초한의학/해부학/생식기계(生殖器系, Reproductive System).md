...
**이 표는 임상 틀이지 동일 근거수준의 권고가 아니다.** 임신부 금침혈(삼음교·합곡合谷·곤륜崑崙 등)에 대한 전통적 금기는 대부분 고전 문헌의 경험적 기재에 근거하며, 현대 임상시험에서 이 경혈들의 자극이 실제로 유산·조산을 유발한다는 통제된 인간 대상 근거는 제한적이다. 다만 안전을 우선하는 임상 관행상 임신 중에는 이러한 경혈의 자침을 신중히 결정하는 것이 일반적이다.
