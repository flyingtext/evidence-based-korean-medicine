...
```mermaid
graph TD
    A["근육계<br/>筋肉系"] --> B["골격근<br/>骨格筋(횡문근·수의근)"]
    A --> C["심장근<br/>心臟筋(횡문근·불수의근)"]
    A --> D["평활근<br/>平滑筋(민무늬근·불수의근)"]
    B --> B1["체성신경 지배<br/>관절 운동·자세 유지"]
    C --> C1["심장벽<br/>자율신경+고유 전도계"]
    D --> D1["혈관벽·소화관·기관지·<br/>방광·자궁 등 관상장기 벽"]
```
...
```mermaid
graph TD
    Complex["근건인대 복합체<br/>筋腱靭帶 複合體"] --> Muscle["골격근<br/>(수축력 발생)"]
    Complex --> Tendon["건<br/>腱(장력 전달, 골 부착)"]
    Complex --> Ligament["인대<br/>靭帶(뼈-뼈 연결, 관절 안정화)"]
    Muscle --> Tendon
    Tendon --> Bone["골격<br/>(부착점 enthesis)"]
    Ligament --> Bone
```
...
```mermaid
graph TD
    Fascia["근막<br/>筋膜"] --> Endo["근내막<br/>(개별 근섬유)"]
    Fascia --> Peri["근주막<br/>(근다발)"]
    Fascia --> Epi["근외막<br/>(근육 전체)"]
    Fascia --> Deep["심근막<br/>深筋膜(근육군 경계)"]
```
...
```mermaid
graph TD
    Involuntary["불수의근"] --> Cardiac["심장근<br/>心臟筋"]
    Involuntary --> Smooth["평활근<br/>平滑筋"]
    Cardiac --> Wall1["심장벽 심근층<br/>(순환계 문서)"]
    Smooth --> Wall2["혈관벽 중막<br/>(혈관 문서)"]
    Smooth --> Wall3["위장관벽 근육층<br/>(소화기계 문서)"]
    Smooth --> Wall4["기관지·방광·자궁벽"]
```
...
[^1]: Exploring the role of traditional Chinese medicine in sarcopenia: mechanisms and therapeutic advances. Yao J 외. _Frontiers in Pharmacology_. 2025-06-30. [문헌 고찰] [DOI 10.3389/fphar.2025.1541373](https://doi.org/10.3389/fphar.2025.1541373) — 한약·침·기공 통합 치료가 근감소증의 근육량·근력·삶의 질 개선에 효과적임을 시사.
...
[^21]: Effect of Siguan Acupuncture on Gastrointestinal Motility: A Randomized, Sham-Controlled, Crossover Trial. Shin KM 외. _Evidence-Based Complementary and Alternative Medicine_. 2013. [임상시험, 21명] [DOI 10.1155/2013/918392](https://doi.org/10.1155/2013/918392) — 사관혈(합곡·태충(LR3)) 침 치료가 가속화된 위장관 운동성을 유의하게 감소.
