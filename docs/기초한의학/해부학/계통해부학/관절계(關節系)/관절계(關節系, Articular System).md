...
```mermaid
graph TD
    A["관절<br/>關節"] --> B["섬유관절<br/>纖維關節(부동관절)"]
    A --> C["연골관절<br/>軟骨關節(반가동관절)"]
    A --> D["활막관절<br/>滑膜關節(가동관절)"]
    D --> D1["경첩관절(예: 주관절)"]
    D --> D2["차축관절(예: 정중환축관절)"]
    D --> D3["타원관절(예: 요골수근관절)"]
    D --> D4["안장관절(예: 수근중수관절)"]
...
```mermaid
graph TD
    Spinal["척추관절<br/>脊椎關節"] --> Disc["추간관절<br/>(추간판, 연골관절)"]
    Spinal --> Facet["후관절<br/>後關節(활막관절)"]
    Spinal --> SI["천장관절<br/>薦腸關節"]
```
...
```mermaid
graph TD
    Upper["상지관절<br/>上肢關節"] --> Sh["견관절<br/>肩關節(구상관절)"]
    Upper --> El["주관절<br/>肘關節(복합관절)"]
    Upper --> Wr["수근관절<br/>手根關節"]
    El --> El1["상완척골관절(경첩관절)"]
    El --> El2["상완요골관절"]
    El --> El3["근위요척관절"]
    Wr --> Wr1["요골수근관절(타원관절)"]
...
```mermaid
graph TD
    Lower["하지관절<br/>下肢關節"] --> Hip["고관절<br/>股關節(구상관절)"]
    Lower --> Knee["슬관절<br/>膝關節"]
    Lower --> Ankle["족관절<br/>足關節(경첩관절)"]
    Knee --> K1["대퇴경골관절"]
    Knee --> K2["슬개대퇴관절"]
    Ankle --> A1["거골(경골·비골 원위단과 관절)"]
```
...
```mermaid
graph TD
    TMJ["측두하악관절<br/>顳顎關節"] --> Upper["상강<br/>(측두골 하악와-관절원판)"]
    TMJ --> Lower["하강<br/>(관절원판-하악과두)"]
    TMJ --> Disc["관절원판<br/>關節圓板"]
```
...
[^1]: Research Progress on Acupuncture Treatment of Knee Osteoarthritis. Yueyu Z 외. _Asian Journal of Complementary and Alternative Medicine_. 2021-11-24. [문헌 고찰] [DOI 10.53043/2347-3894.acam90019](https://doi.org/10.53043/2347-3894.acam90019) — 침·뜸 치료가 무릎 골관절염 환자의 통증·기능·염증·조직 회복에 유의미한 효과가 있음을 종합.
[^2]: Unilateral versus Bilateral Acupuncture on Knee Function in Advanced Osteoarthritis of the Knee – a Prospective Randomised Trial. Tillu A 외. _Acupuncture in Medicine_. 2001-06. [임상시험, 44명] [DOI 10.1136/aim.19.1.15](https://doi.org/10.1136/aim.19.1.15) — 편측·양측 침 치료 모두 무릎 기능·통증 개선에 유의하며 두 방법 간 차이는 없음.
...
[^74]: Acupuncture for ankle sprain: systematic review and meta-analysis. Park J 외. _BMC Complementary and Alternative Medicine_. 2013-03-04. [메타분석, 1820명] [DOI 10.1186/1472-6882-13-55](https://doi.org/10.1186/1472-6882-13-55) — 침 치료가 발목 염좌의 증상 개선·통증 완화·일상 복귀에 긍정적 영향을 미칠 수 있음.
...
[^93]: Effect of Barrier-Separated Moxibustion on the Governing Vessel and Chronic Disease Management in Elderly Rheumatoid Arthritis Patients. Ren H 외. _Acupuncture & Electro-Therapeutics Research_. 2025-09-24. [임상시험, 92명] [DOI 10.1177/03601293251378889](https://doi.org/10.1177/03601293251378889) — 독맥 격리식 뜸과 만성질환 관리 병행이 표준 약물 단독보다 관절 부종·압통·조조강직 개선에 효과적.
...
[^109]: Electroacupuncture on Hemifacial Spasm and Temporomandibular Joint Pain Co-Morbidity: A Case Report. Huang JP 외. _Frontiers in Neurology_. 2022-06-28. [증례 보고, 1명] [DOI 10.3389/fneur.2022.931412](https://doi.org/10.3389/fneur.2022.931412) — 안면경련·TMJ 통증 동반 환자에게 전침을 30주간 시행해 증상 유의 감소.
[^110]: Thread Embedding Acupuncture for Temporomandibular Disorder: Protocol for a Randomized controlled Clinical Trial. Park J 외. 2025-03-07. [임상시험, 76명] [DOI 10.1101/2025.03.05.25323430](https://doi.org/10.1101/2025.03.05.25323430) — 만성 TMD에 매선침의 효능·안전성·비용효과성을 평가하는 프로토콜.
