...
**약전 수재 사항**: 대한민국약전(KP)은 이 약재를 한글 수재명 **현호색(玄胡索)**, 라틴 생약명 **Corydalis Tuber** 로 등재하고, 기원종으로 **들현호색(*Corydalis ternata* Nakai)과 연호색(延胡索, *Corydalis yanhusuo* W. T. Wang) 두 종** 을 함께 인정하며 약용부위를 덩이줄기(塊莖)로 규정한다. 즉 한국에서 '연호색'은 약전상 현호색 항목에 포함되는 기원종의 하나이자 그 약재명이며, 국제 문헌에 흔한 `Corydalis Rhizoma`(중국 문헌의 관행 표기)는 약전 라틴명이 아니다. 약용부위가 뿌리줄기(rhizoma)가 아니라 덩이줄기(tuber)라는 점이 라틴명에 반영되어 있으므로, 문헌 대조 시 `Corydalis Rhizoma`·`Rhizoma Corydalis` 표기도 같은 약재를 가리키는 것으로 읽되 인용 표기는 약전명을 기준으로 삼는다.
...
| *Corydalis ternata* | 들현호색 | 한국 자생종이며 **대한민국약전이 현호색의 정기원으로 인정하는 종** 이다. '대용품'이 아니라 약전 규격품이므로, 국내 유통 현호색이 이 종일 수 있음을 전제로 문헌을 읽어야 한다 |
