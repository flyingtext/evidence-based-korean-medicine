...
[^1]: The Use of Chinese Herbal Products for Nasopharyngeal Carcinoma in Taiwan: A Population-Based Study. Tseng ST 외. _Preprints.org_. 2018-09-26. [관찰연구] [DOI 10.20944/preprints201809.0498.v1](https://doi.org/10.20944/preprints201809.0498.v1) — 대만 비인두암 환자 3만여 명의 중약 이용 패턴을 분석해 백화사설초 등의 빈용을 확인한 대규모 인구 기반 연구.
...
[^55]: Use of Jianpi Jiedu Herbs in Patients with Advanced Colorectal Cancer: A Systematic Review and Meta-Analysis. Zhang S 외. _Evidence-Based Complementary and Alternative Medicine_. 2018-01. [메타분석] [DOI 10.1155/2018/6180810](https://doi.org/10.1155/2018/6180810) — 삶의 질·부작용은 개선되었으나 **종양 반응에는 유의한 효과가 없었던** 음성 결과를 함께 보고한 메타분석.
...
[^63]: The efficacy and safety of modified Gegenqinlian Formular for advanced colorectal cancer (damp heat accumulation type). Wang ZJ 외. _Medicine_. 2021-12-10. [임상시험] [DOI 10.1097/md.0000000000027850](https://doi.org/10.1097/md.0000000000027850) — 습열축적형으로 대상을 층화한 임상시험 계획으로, 변증 층화 설계가 시도되고 있음을 보여주는 자료(결과 미발표).
...
[^70]: Chinese Herbal Medicine as an Adjunctive Therapy for Liver Cancer: A Systematic Review and Meta-Analysis. Wang Y 외. _Natural Product Communications_. 2025-10. [메타분석] [DOI 10.1177/1934578x251366378](https://doi.org/10.1177/1934578x251366378) — 간암 병용군의 반응률·생존과 함께 간기능 지표 개선을 보고한 최신 메타분석.
...
[^72]: Astragalus-Containing Chinese Herbal Medicine Combined With Chemotherapy for Cervical Cancer: A Systematic Review and Meta-Analysis. Shen L 외. _Frontiers in Pharmacology_. 2021-07-30. [메타분석] [DOI 10.3389/fphar.2021.587021](https://doi.org/10.3389/fphar.2021.587021) — 자궁경부암에서 보기약 중심 배오와 화학요법 병용의 반응률·독성 지표 개선을 보고한 메타분석.
