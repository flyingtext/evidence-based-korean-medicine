...
| 흉민·심계 | 내관(PC6)·거궐(CV14)·심수(BL15)·단중(CV17)·풍륭(ST40) |
| 비만·담습 | 중완(CV12)·천추(ST25)·풍륭(ST40)·음릉천(SP9)·족삼리(ST36)·삼음교(SP6) |
| 불면·다몽 | 신문(HT7)·내관(PC6)·삼음교(SP6)·풍륭(ST40)·단중(CV17) |
...
**침구**: 풍륭(ST40)·내관(PC6)·거궐(CV14)·심수(BL15)·단중(CV17)·비수(BL20)·족삼리(ST36). 고혈압 담어형에는 풍륭·태충(LR3)·풍지(GB20) 사법. 뇌졸중에는 백회(GV20)·풍지(GB20)·풍륭·태충·합곡(LI4). 경동맥 죍상경화에는 약떡격구·국소 치침.
