...
6. **각주 정의** — 본문의 각주(`[^n]`) 정의 (제목·연구유형·저널·DOI/PMID 링크). 참고문헌 섹션은 별도로 두지 않으며, 출처 정보는 각주 정의로 통일한다. 각주 정의는 문서 맨 끝에 **`## 참고문헌` 헤더 없이, 불릿 기호(`-`) 없이** 각주 마커(`[^n]:`)로만 나열한다.

**각주 사용 원칙**: 근거 요약·임상 적용 등 본문에서 임상적 주장을 서술할 때 각 임상적 주장 끝에 각주 `[^n]`를 달아 해당 근거 논문(제목·연구유형·저널·DOI/PMID 링크)을 연결한다. 별도의 근거 표를 두지 않고, 모든 출처 정보는 각주 정의로 통일한다.
